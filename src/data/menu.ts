...
export const MENU: MenuItem[] = [
  ...
  // ---------- RICE BOWL ----------
  {
    ...
    price: 'Rp30.000',
    images: [{ label: 'Foto', src: '/menu/katsui-cikkin.jpg' }],
  },
  {
  ...
  {
    cat: 'rice_bowl', icon: '', name: 'Bitteu Cikkin', says: '/ Spicy Chicken',
    desc: 'Ayam pedas lengkap dengan nasi dan salad. Berat tapi nagih.',
    price: 'Rp30.000',
    images: [{ label: 'Foto', src: '/menu/bitteu-cikkin.jpg' }],
  },
  {
  ...
  },
  {
    ...
    price: 'Rp40.000',
    images: [{ label: 'Foto', src: '/menu/bifbluegogy.jpg' }],
  },
  ...
  // ---------- BEVERAGE — SWEETY ----------
  { cat: 'beverage', sub: 'sweety', icon: '', name: 'Red Velvet', says: '/ Red Velvet', desc: 'Minuman creamy dengan rasa red velvet yang mewah.', price: 'Rp25.000' },
